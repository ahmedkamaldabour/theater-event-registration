<head>
    ...
    <link href="{{asset('AdminAssets')}}/layouts/horizontal-dark-menu/css/light/loader.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('AdminAssets')}}/layouts/horizontal-dark-menu/css/dark/loader.css" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('AdminAssets')}}/layouts/horizontal-dark-menu/css/light/plugins.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('AdminAssets')}}/layouts/horizontal-dark-menu/css/dark/plugins.css" rel="stylesheet" type="text/css" />
